							...
							<form action="#" class="dropdown">
								<div class="searchinputs input-group dropdown-toggle" id="dropdownMenuClickable" data-bs-toggle="dropdown" data-bs-auto-close="outside">
									...
									<span class="input-group-text">
										<kbd class="d-flex align-items-center"><img src="admin_assets/img/icons/command.svg" alt="img" class="me-1">K</kbd>
									</span>
								</div>
								<div class="dropdown-menu search-dropdown" aria-labelledby="dropdownMenuClickable">
									<div class="search-info">
										...
										<ul class="search-tags">
											<li><a href="javascript:void(0);">AAAProducts</a></li>
									...
									<div class="search-info">
										...
										<ul class="customers">
											<li><a href="javascript:void(0);">Aron Varu<img src="admin_assets/img/profiles/avator1.jpg" alt="Img" class="img-fluid"></a></li>
											<li><a href="javascript:void(0);">Jonita<img src="admin_assets/img/profiles/avatar-01.jpg" alt="Img" class="img-fluid"></a></li>
											<li><a href="javascript:void(0);">Aaron<img src="admin_assets/img/profiles/avatar-10.jpg" alt="Img" class="img-fluid"></a></li>
										</ul>
									</div>
								</div>
							</form>
					...
					<!-- <li class="nav-item dropdown has-arrow main-drop select-store-dropdown">
						<a href="javascript:void(0);" class="dropdown-toggle nav-link select-store"
							...
							<span class="user-info">
								<span class="user-letter">
									<img src="admin_assets/img/store/store-01.png" alt="Store Logo" class="img-fluid">
								</span>
						...
						<div class="dropdown-menu dropdown-menu-right">
							<a href="javascript:void(0);" class="dropdown-item">
								<img src="admin_assets/img/store/store-01.png" alt="Store Logo" class="img-fluid">Freshmart
							</a>
							<a href="javascript:void(0);" class="dropdown-item">
								<img src="admin_assets/img/store/store-02.png" alt="Store Logo" class="img-fluid">Grocery Apex
							</a>
							<a href="javascript:void(0);" class="dropdown-item">
								<img src="admin_assets/img/store/store-03.png" alt="Store Logo" class="img-fluid">Grocery Bevy
							</a>
							<a href="javascript:void(0);" class="dropdown-item">
