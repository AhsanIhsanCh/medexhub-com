		...
		<div id="sidebar-menu" class="sidebar-menu">
			<ul>
				...
				<li class="submenu-open">
					...
					<ul>
						<li class="submenu">
							<a href="javascript:void(0);" class=""><i class="ti ti-building-bank fs-16 me-2"></i><span>Accounts</span><span class="menu-arrow"></span></a>
							<ul>
								<li><a href="/admin-payment" >Payments</a></li>
								<li><a href="/admin-return-payment" >Payments Return</a></li>
								<li><a href="/admin-miscellaneous-payment" >Miscellaneous Payment</a></li>
							</ul>
						</li>
					</ul>
				</li>
				<li class="submenu-open">
					...
					<ul>
						<li class="submenu">
							<a href="javascript:void(0);" class=""><i class="ti ti-users-group fs-16 me-2"></i><span>Users</span><span class="menu-arrow"></span></a>
							<ul>
								<li><a href="/admin-users" >Users</a></li>
								<li><a href="/admin-users-pending" >Pending Validation</a></li>
								<li><a href="/admin-users-ban" >Ban Users</a></li>
							</ul>
						</li>
					</ul>
				</li>
				<li class="submenu-open">
					<h6 class="submenu-hdr">Conversation</h6>
					<ul>
						<li class="submenu">
							<a href="javascript:void(0);" class=""><i class="ti ti-brand-hipchat fs-16 me-2"></i><span>Conversation</span><span class="menu-arrow"></span></a>
							<ul>
								<li><a href="/admin-conversation" >Conversation</a></li>
				...
				<li class="submenu-open">
					<h6 class="submenu-hdr">Archives</h6>
					<ul>
						<li class="submenu">
							<a href="javascript:void(0);" class=""><i class="ti ti-clipboard-search fs-16 me-2"></i><span>Archives</span><span class="menu-arrow"></span></a>
							<ul>
								<li><a href="/admin-exams" >Exams</a></li>
								<li><a href="/admin-mcq" >MCQ</a></li>
								<li><a href="/admin-emq" >EMQ</a></li>
								<li><a href="/admin-flash-card" >Flash Card</a></li>
								<li><a href="/admin-kfp1" >Select the Options (KFP 1)</a></li>
								<li><a href="/admin-kfp2" >Free Text Questions (KFP 2)</a></li>
							</ul>
						</li>
					</ul>
				</li>
				<li class="submenu-open">
					<h6 class="submenu-hdr">Add On</h6>
					<ul>
						<li class="submenu">
							<a href="javascript:void(0);" class=""><i class="ti ti-puzzle fs-16 me-2"></i><span>Add On</span><span class="menu-arrow"></span></a>
							<ul>
								<li><a href="/admin-exam-year" >Exam Year</a></li>
				...
				<li class="submenu-open">
					<h6 class="submenu-hdr">Maintenance</h6>
					<ul>
						<li class="submenu">
							<a href="javascript:void(0);" class=""><i class="ti ti-barrier-block-off fs-16 me-2"></i><span>Maintenance</span><span class="menu-arrow"></span></a>
							<ul>
								<li><a href="/admin-maintenance-session" >Session Maintenance</a></li>
								<li><a href="/admin-maintenance-login" >Login Maintenance</a></li>
							</ul>
						</li>
					</ul>
				</li>
...
<div class="sidebar sidebar-horizontal" id="horizontal-menu">
	<div id="sidebar-menu-3" class="sidebar-menu">
		<div class="main-menu">
			<ul class="nav-menu">
				<li class="submenu">
					<a href="index.html"><i class="ti ti-layout-grid fs-16 me-2"></i><span> Dashboard</span> <span class="menu-arrow"></span></a>
					<ul>
						<li class="submenu">
				...
				<li class="submenu">
					<a href="index.html"><i class="ti ti-building-bank fs-16 me-2"></i><span> Accounts</span> <span class="menu-arrow"></span></a>
					<ul>
						<li class="submenu">
							<li><a href="/">Payments</a></li>
							<li><a href="/">Payments Return</a></li>
							<li><a href="/">Miscellaneous Payment</a></li>
						</li>
					</ul>
				</li>
				<li class="submenu">
					<a href="index.html"><i class="ti ti-users-group fs-16 me-2"></i><span> Users</span> <span class="menu-arrow"></span></a>
					<ul>
						<li class="submenu">
							<li><a href="/">Users</a></li>
							<li><a href="/">Pending Validation</a></li>
							<li><a href="/">Ban Users</a></li>
						</li>
					</ul>
				</li>
				<li class="submenu">
					<a href="index.html"><i class="ti ti-brand-hipchat fs-16 me-2"></i><span> Conversation</span> <span class="menu-arrow"></span></a>
					<ul>
						<li class="submenu">
				...
				<li class="submenu">
					<a href="index.html"><i class="ti ti-clipboard-search fs-16 me-2"></i><span> Archives</span> <span class="menu-arrow"></span></a>
					<ul>
						<li class="submenu">
							...
							<li><a href="/">Select&nbsp;the&nbsp;Options&nbsp;(KFP&nbsp;1)</a></li>
							<li><a href="/">Free&nbsp;Text&nbsp;Questions&nbsp;(KFP&nbsp;2)</a></li>
						</li>
					</ul>
				</li>
				<li class="submenu">
					<a href="index.html"><i class="ti ti-puzzle fs-16 me-2"></i><span> Add On</span> <span class="menu-arrow"></span></a>
					<ul>
						<li class="submenu">
							<li><a href="/">Exam Year</a></li>
				...
				<li class="submenu">
					<a href="index.html"><i class="ti ti-barrier-block-off fs-16 me-2"></i><span> Maintenance</span> <span class="menu-arrow"></span></a>
					<ul>
						<li class="submenu">
							<li><a href="/">Session Maintenance</a></li>
							<li><a href="/">Login Maintenance</a></li>
						</li>
					</ul>
				</li>
			</ul>
				...
				<div class="twocol-mini">
					<div class="sidebar-left slimscroll">
						<div class="nav flex-column align-items-center nav-pills" id="sidebar-tabs" role="tablist"
							...
							<a href="#" class="nav-link " title="Account" data-bs-toggle="tab" data-bs-target="#account">
								<i class="ti ti-building-bank"></i>
							</a>
							<a href="#" class="nav-link " title="Users" data-bs-toggle="tab" data-bs-target="#users">
								<i class="ti ti-users-group"></i>
							</a>
							<a href="#" class="nav-link" title="Layout" data-bs-toggle="tab" data-bs-target="#conversation">
								<i class="ti ti-brand-hipchat"></i>
							</a>
							<a href="#" class="nav-link" title="Inventory" data-bs-toggle="tab" data-bs-target="#archives">
								<i class="ti ti-clipboard-search"></i>
							</a>
							<a href="#" class="nav-link" title="Stock" data-bs-toggle="tab" data-bs-target="#add-on">
								<i class="ti ti-puzzle"></i>
							</a>
							<a href="#" class="nav-link" title="Sales" data-bs-toggle="tab" data-bs-target="#maintenance">
					...
					<div class="sidebar-scroll">
						...
						<div class="tab-content" id="v-pills-tabContent">
							...
							<div class="tab-pane fade" id="conversation">
								<ul>
									<li class="menu-title"><span>Conversation</span></li>
									<li><a href="/">Conversation</a></li>
								</ul>
							</div>
							<div class="tab-pane fade" id="archives">
								<ul>
									<li class="menu-title"><span>Archives</span></li>
									<li><a href="/">Exams</a></li>
									<li><a href="/">MCQ</a></li>
									<li><a href="/">EMQ</a></li>
									<li><a href="/">Flash Card</a></li>
							...
							<div class="tab-pane fade" id="add-on">
								<ul>
									<li class="menu-title"><span>Add On</span></li>
									<li><a href="/">Exam Year</a></li>
									<li><a href="/">Medicine</a></li>
									<li><a href="/">Coupons</a></li>
								</ul>
								...
								<ul>
									...
									<li class="submenu">
										...
										<ul>
											...
											<li><a href="https://dreamspos.dreamstechnologies.com/food-pos/html/template/index.html" target="_blank">POS 6</a></li>
							...
							<div class="tab-pane fade" id="extras">
								<ul>
									...
									<li><a href="https://preadmin.dreamstechnologies.com/documentation/index.html" target="_blank"><span>Documentation</span></a></li>
									<li><a href="https://preadmin.dreamstechnologies.com/documentation/changelog.html" target="_blank"><span>Changelog v2.2.5</span></a></li>
									<li class="submenu">
