        ...
        <main class="col-12 col-lg-9">
                ...
                @if($DispalyType == 1)
                    ...
                    @if ($QuestionQT == '1')
                        ...
                        <div class="section-heading d-flex align-items-center justify-content-between pb-2 mb-3">
                            ...
                            <span class="small fw-semibold text-secondary" id="questionCounter">{{$QuestionNo}} of {{$TestLenth}}</span>
                        </div>
                    ...
                    @if ($QuestionQT == '2')
                        ...
                        <div class="section-heading d-flex align-items-center justify-content-between pb-2 mb-3">
                            ...
                            <span class="small fw-semibold text-secondary" style="margin-bottom: -20px;" >{{$QuestionNoC}} of {{$TestLenth}}</span>
                        </div>
                        <section class="card question-card shadow-sm mb-3">
                            <div class="card-body p-4">
                    ...
                    @if ($QuestionQT == '3')
                        ...
                        <div class="section-heading d-flex align-items-center justify-content-between pb-2 mb-3">
                            <span class="badge rounded-pill text-bg-primary-subtle border border-primary-subtle text-primary-emphasis px-3 py-2" id="questionBadge">EMQ</span>
                            <span class="small fw-semibold text-secondary" style="margin-bottom: -20px;" >{{$QuestionNo}} of {{$TestLenth}}</span>
                        </div>
                        <section class="card question-card shadow-sm mb-3">
                            <div class="card-body p-4">
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-2 mt-4">
                            ...
                            @endphp
                            <a href="/submitrfc/{{$string}}" class="btn btn-primary px-4"><i class="fas fa-arrow-right"></i> Next Fact</a>    
                            <a href="/finishexam/{{$testid}}" class="btn btn-success ms-lg-auto" id="finishBtn">Finish exam</a>
                        </div>
                        </form>
                    @endif
                ...
                @if($DispalyType == 2)
                    ...
                    @if ($QuestionQT == '1')
                            ...
                            for($i = 1; $i <= $MCQOptionCount; $i++)
                                {
                                    ...
                                    if($CorrectAnswer == $Alphabet)
                                        {
                                            echo '<input type="radio"  name="option" disabled value="'.$i.'" id="'.$SmallAlphabet.'">
                                            <label for="'.$SmallAlphabet.'" class="answer-option option-card  selected correct">
                                                <div class="left">
                                                <div class="letter">' . $Alphabet . '</div>
                                                <span>' . ${$Option} . '</span>
                                                </div>
                                    ...
                                    else 
                                        {
                                            if($UserAnswer == $Alphabet)
                                                {
                                                    echo '<input type="radio"  name="option" disabled value="'.$i.'" id="'.$SmallAlphabet.'">
                                                    <label for="'.$SmallAlphabet.'" class="answer-option option-card  selected incorrect">
                                                        <div class="left">
                                                        <div class="letter">' . $Alphabet . '</div>
                                                        <span>' . ${$Option} . '</span>
                                                        </div>
                        ...
                        <section class="card question-card shadow-sm mb-3">
                            <div class="card-body p-4">
                                <p class="question-text mb-0" id="questionText">{!! $QuestionExplanation !!}</p>
                            </div>
                        </section> 
                        <div class="d-flex flex-wrap align-items-center gap-2 mt-4">
                            <input type="hidden" name="Question_ID" value="{{ $QuestionID }}">
                            ...
                            @if($TestLenth != $QuestionNo)
                                    <input type="submit" class="btn btn-primary px-4" value="Next Question">
                                @else    
                                    <input type="submit" class="btn btn-primary px-4" value="View Overall Result">
                                @endif   
                            <a href="/finishexam/{{$testid}}" class="btn btn-success ms-lg-auto" id="finishBtn">Finish exam</a>
                        </div>
                        </form>
                    ...
                    @if ($QuestionQT == '2')
                        ...
                        @php
                            ...
                            $QuestionReference = $QuestionEMQ->first()->emq_reference ?? 'No Question Found';
                            $QuestionLeadIn = $QuestionEMQ->first()->emq_lead_in ?? 'No Question Found';
                            $EMQQuestionCount2 = $QuestionEMQ->first()->emq_q_count ?? 0;
                            if($QuestionNo == 0) $QuestionNoC = 1; 
                            else
                                { 
                                    $QuestionNo2 = $QuestionNo - $EMQQuestionCount2;    
                                    $QuestionNoC = $QuestionNo2 + 1;
                                }    
                        @endphp   
                        <div class="section-heading d-flex align-items-center justify-content-between pb-2 mb-3">
                            <span class="badge rounded-pill text-bg-primary-subtle border border-primary-subtle text-primary-emphasis px-3 py-2" id="questionBadge">EMQ</span>
                                        ...
                                        if($UserAnswer == $CorrectAnswer)
                                            {
                                                ...
                                                echo '<label class="answer-option option-card correct">';
                                                    echo '<span style="color: green;"><strong>Correct Answer (' . $CorrectAnswer . ') : </strong>' . $Option . '</span>';
                                                echo '</label>';   
                                            }
                                        else
                                            {
                                                $ColNumber = ord($UserAnswer) - 64;
                                                $EMQOptionCol2 = "emq_op_".$ColNumber;
                                                $Option = $QuestionEMQ->first()->$EMQOptionCol2 ?? 'No Option Found';
                                                echo '<label class="answer-option option-card incorrect">';
                                                    echo '<span style="color: red;"><strong>Your Answer (' . $UserAnswer . ') : </strong>' . $Option . '</span>';
                                                echo '</label>';
                                                $ColNumber = ord($CorrectAnswer) - 64;
                                                $EMQOptionCol2 = "emq_op_".$ColNumber;
                                                $Option = $QuestionEMQ->first()->$EMQOptionCol2 ?? 'No Option Found';
                    ...
                    @if ($QuestionQT == '3')
                        ...
                        @endphp
                        <div class="section-heading d-flex align-items-center justify-content-between pb-2 mb-3">
                            <span class="badge rounded-pill text-bg-primary-subtle border border-primary-subtle text-primary-emphasis px-3 py-2">Fact No : {{$QuestionNo}}</span>
                            <span class="small fw-semibold text-secondary" style="margin-bottom: -20px;" >{{$QuestionNo}} of {{$TestLenth}}</span>
                        </div>
                        <section class="card question-card shadow-sm mb-3">
                            <div class="card-body p-4">
                        ...
                        <div class="alert mt-3 mb-0 alert-light shadow">
                        ...
                        <div class="d-flex flex-wrap align-items-center gap-2 mt-4">
                            ...
                            @php
                                ...
                                $string = implode(",", $linkData1);
                            @endphp
                            <a href="/submitrafc/{{$string}}" class="btn btn-primary px-4"><i class="fas fa-arrow-right"></i> Next Fact</a>    
                            <a href="/finishexam/{{$testid}}" class="btn btn-success ms-lg-auto" id="finishBtn">Finish exam</a>
                        </div>
                        </form>    
                    @endif
...
@endforeach
@php
$QuestionLeft = $TestLenth - $GharfNumber;
@endphp
<script>
